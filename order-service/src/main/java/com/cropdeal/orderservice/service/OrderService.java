...
//	        // Update the receipt in the repository
	...
	private void processPaymentAdjustment(Order oldOrder, Order updatedOrder) {
		...
		// Send the necessary payment details, such as the order ID, original amount,
		// and adjusted amount, to the payment gateway
		// Handle the payment gateway response and update the order/payment status
		// accordingly
