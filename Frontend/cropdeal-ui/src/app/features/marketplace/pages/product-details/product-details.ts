...
export class ProductDetailsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    if (!id) {
      this.errorMessage.set('Product information is missing.');
  ...
  addToCart(): void {
    ...
    if (user.role !== 'DEALER') {
      this.errorMessage.set('Only buyer accounts can add products to cart.');
      return;
    }
    ...
    this.cartService.addToCart(
      ...
      error: error => {
        ...
        this.addingToCart.set(false);
        this.errorMessage.set('Unable to add this product to your cart.');
      }
    });
  }
